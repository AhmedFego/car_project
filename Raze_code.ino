...
RD.setSpeed(255);
  ...
  break;
    case '9':
    m_state = (flipp)?2:1;
      speed((flipp)?50:100,LT);
      speed((flipp)?50:100,LD);
      speed((flipp)?100:50,RT);
      speed((flipp)?100:50,RD);
      break;
      case '7':
    m_state = (flipp)?2:1;
      speed((flipp)?100:50,LT);
      speed((flipp)?100:50,LD);
      speed((flipp)?50:100,RT);
      speed((flipp)?50:100,RD);
      break;
      case '3':
    m_state = (flipp)?1:2;
      speed((flipp)?50:100,LT);
    ...
    case '4':
       ...
       m_state = (flipp)?2:1;
      speed((flipp)?100:0,LT);
      speed((flipp)?100:0,LD);
      speed((flipp)?0:100,RT);
      speed((flipp)?0:100,RD);
      break;
    case '6':

       m_state = (flipp)?2:1;
      speed((flipp)?0:100,LT);
      speed((flipp)?0:100,LD);
      speed((flipp)?100:0,RT);
      speed((flipp)?100:0,RD);
      break;
      default :
   m_state = 1;
      speed(0,LT);
